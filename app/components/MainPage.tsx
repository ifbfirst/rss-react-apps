...
import FlyoutBox from '@/app/components/FlyoutBox';
import Pagination from '@/app/components/Pagination';
import PeopleList from '@/app/components/PeopleList';
import Search from '@/app/components/Search';
import { PAGINATION_PAGE } from '@/app/constants';
import store from '@/app/stores';
import { setPage } from '@/app/stores/peopleSlice';
import { RootState, useFetchPeopleQuery } from '@/app/stores/reducers';
        ...
        <div className="app">
          ...
          <main className="main">
            <div className="people-wrapper">
              ...
              <div className="person-detail">{/* <Outlet /> */}</div>
            </div>
